...
const translations = {
  ...
  ua: {
    ...
    cta: {
      ...
      text: 'Давайте обговоримо як ми можемо створити сайт, який не тільки виглядає чудово, але й забезпечує реальне зростання вашого бізнесу.',
